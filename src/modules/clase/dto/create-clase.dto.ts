...
export class CreateClaseDto {
  ...
  @IsIn(TIPOS_CLASE, {
    message: `Tipo inválido. Valores permitidos: ${TIPOS_CLASE.join(", ")}`,
  })
  tipo: string;
  ...
  @IsOptional()
  @IsIn(DIAS_SEMANA, {
    message: `Día de la semana inválido. Valores permitidos: ${DIAS_SEMANA.join(", ")}`,
  })
  diaSemana?: string;

  @IsIn(HORARIOS, {
    message: `Horario inválido. Valores permitidos: ${HORARIOS.join(", ")}`,
  })
  hora: string;
