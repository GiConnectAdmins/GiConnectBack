...
export class PersonController {
  ...
  @Put('me/password')
  @UseGuards(JwtAuthGuard)
  cambiarPassword(@CurrentUser() user: PersonDocument, @Body() dto: ChangePasswordDto) {
  ...
  @Get(':id')
  @UseGuards(JwtAuthGuard)
  getById(@Param('id', ParseObjectIdPipe) id: string, @CurrentUser() user: PersonDocument) {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('Admin')
  cambiarRol(@Param('id', ParseObjectIdPipe) id: string, @Body() dto: ChangeRoleDto) {
  ...
  @UseGuards(JwtAuthGuard, RolesGuard)
  @Roles('Admin')
  remove(@Param('id', ParseObjectIdPipe) id: string, @CurrentUser() user: PersonDocument) {
